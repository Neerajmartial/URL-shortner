...
//           >
//             <h1></h1>Linklytics Simplifies URL Shortening For Efficient Sharing.
//           </motion.h1>
...
let desc =
  "Generate short, memorable links with ease using SmartUrl’s intuitive interface. Share URLs effortlessly across platforms. Optimize your sharing strategy with Linklytics. Track clicks and manage your links seamlessly to enhance your online presence. Generate short, memorable links with ease using Linklytics’s intuitive interface. Share URLs effortlessly across platforms.";
      ...
      <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
        <div className=" flex-1">
          <motion.h1
            ...
            className="font-bold font-roboto text-slate-800 md:text-5xl sm:text-4xl text-3xl   md:leading-[55px] sm:leading-[45px] leading-10 lg:w-full md:w-[70%] w-full"
          >
            SmartUrl Simplifies URL Shortening For Efficient Sharing.
          </motion.h1>
          <motion.p
          ...
          >
            {/* <p className="text-slate-700 text-sm my-5"> */}
              SmartUrl streamlines the process of URL shortening, making sharing
              links effortless and efficient. With its user-friendly interface,
              SmartUrl allows you to generate concise, easy-to-share URLs in
              seconds. Simplify your sharing experience with SmartUrl today.
            {/* </p> */}
          </motion.p>
